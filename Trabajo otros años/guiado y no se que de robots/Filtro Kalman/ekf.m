...
trayectoriaD = zeros(1,length(2*numerodepasos));
trayectoriaDRuido = zeros(1,length(2*numerodepasos));
trayectoriaB = zeros(1,length(2*numerodepasos));
trayectoriaBRuido = zeros(1,length(2*numerodepasos));
...
% Inicializamos la posici?n inicial y su covarianza
xini = 5;
yini = 2;
thetaini = 0;
...
% Algoritmo
Ktotal = zeros(3);
Xreal = zeros(3,length(trayectoriaD));
%Solo para almacenarlo
Xestimado = zeros(3,length(trayectoriaD));
Pacumulado = zeros(3,length(trayectoriaD));
